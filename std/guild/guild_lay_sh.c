 ...
 *
 * query_guild_leader_lay() Define this function to return true of the player
 *                         is considered to be one of the leaders of his/her
 *                         guild in the form of a council-membership, et
 *                         cetera.
 *
 * query_guild_incognito_lay() Define this function so that it returns true if
 ...
 *                leader of his/her layman guild, in a council-membership
...
autoload_shadow(string str)
{
    ...
    ::autoload_shadow(str);
    this_object()->init_lay_shadow(str);
